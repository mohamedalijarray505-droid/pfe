...
<style>
    ...
    .auth-remember input[type="checkbox"] {
        width: 14px;
        height: 14px;
        accent-color: var(--ellyssa-primary);
    }
    ...
    <div class="auth-grid">
        <div class="auth-hero">
            <div>
                <div class="auth-hero-header">
                    ...
                    <div>
                        <div class="auth-hero-title">Bienvenue sur Ellyssa FM</div>
                        <div style="font-size:0.8rem;color:#9ca3af;">Radio & vidéos de la communauté</div>
                    </div>
                </div>
                <p class="auth-hero-subtitle">
                    Connectez-vous pour réagir aux vidéos, laisser des commentaires et suivre l’actualité de la radio.
                </p>
                <div class="auth-hero-badges">
                    <span class="auth-badge"><i class="bi bi-broadcast-pin"></i> Direct & replay</span>
                    <span class="auth-badge"><i class="bi bi-chat-dots"></i> Commentaires modérés</span>
                    <span class="auth-badge"><i class="bi bi-shield-check"></i> Compte sécurisé</span>
                </div>
            </div>
            <div class="auth-wave">
                Conseil : utilisez la même adresse email que pour vos participations à l’antenne pour retrouver vos interactions.
            </div>
        </div>
        ...
        <div class="auth-card">
            <div class="auth-card-header">
                <h2>Connexion</h2>
                <p>Accédez à votre espace Ellyssa FM</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.submit') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" placeholder="vous@exemple.com" value="{{ old('email') }}" required autofocus>
